...
I built this project in 15 hours,  For making this project, I used HTML and CSS only. I applied some important CSS properties like CSS positioning, CSS hover effect, z-index, CSS flexbox,  grid, and other properties. I learn more about positioning, and media queries for making the site responsive for mobile, tab, and desktop view, this project is completely responsive now.
...
#### SAAS landing page project 13 UI [Preview Link](https://project-13-ui.netlify.app/)

---

![shopify.](./img/Screenshot%20(139).png)
